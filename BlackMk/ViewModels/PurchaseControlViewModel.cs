...
{
    public class PurchaseControlListViewModel : BaseViewModel
    {
        ...
        public string ResponsableName { get { return Responsible != null ? EnumUtil.GetDescriptions(Responsible) : null; } }
    }
}
